...
public class TestLibrarianrole {
    ...
    public static void printTheBorrowingResult(int result, String studentId, String bookId) {
        switch (result) {
            case 1 ->
                System.out.println(
                        "The student with id = " + studentId + " has already borrowed a copy of the book with id = "
                                + bookId + " and hasn't returned it yet.");
            case 2 ->
                System.out.println("The student with id = " + studentId
                        + " has successfully borrowed a copy of the book with id = " + bookId + ".");
            case 0 ->
                System.out.println("All copies of the book with id = " + bookId
    ...
    public static void printTheBorrowingFee(double result, String studentId, String bookId) {
        System.out.println("The student with id = " + studentId + " should pay a return fee of " + result
                + " US dollars for the book with id " + bookId);
