...
public class ViewBorrowedBooks extends javax.swing.JFrame implements Node{
    ...
    public ViewBorrowedBooks(backend.LibrarianRole librarian) {
        initComponents();
        this.librarian = librarian;
        String[][] TableData = new String[librarian.getListOfBorrowingOperations().length][5];
        for (int i = 0; i < librarian.getListOfBorrowingOperations().length; i++) {
            TableData[i] = librarian.getListOfBorrowingOperations()[i].lineRepresentation().split(",");
        }
        String columnNames[] = {"Student Id", "Book ID", "Borrow Date"};
